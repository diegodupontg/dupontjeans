...
$respuesta_send="contactosend.htm";
$respuesta_error="contactoerror.htm";
$nombre="Consulta";
...
$para ="ventas@dupontjeans.com";

/* AQUI ESPECIFICAS EL SUJETO (Asunto) DEL EMAIL */
$sujeto = "Se realizo una consulta desde la pagina web";
...
$mensaje .= 
"<div style='font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333 border:20px #FFFFFF'><br>Se realizo una consulta desde la pagina web.<br><br>
